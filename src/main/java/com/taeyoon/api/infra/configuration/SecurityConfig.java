...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
         ...
         */
        http
            .csrf(AbstractHttpConfigurer::disable) // rest 에서는 cookie, session 을 사용하지 않기때문에 disable 처리, disable 하지 않으면 rest api 요청시 403 에러 발생
            .addFilterBefore(new JwtAuthenticationCustomFilter(jwtCustomProvider, SECRET_KEY), UsernamePasswordAuthenticationFilter.class)
